...
└── docs/{requisitos,modelo_documental,consultas_e_indices,checkout_saga,comparacao_relacional_nosql,decisoes,deploy_vercel,plano_nosql}.md · docs/apresentacao/ (gerador do .pptx) · docs/atividades/ (Atividades 3, 3.2 e 3.3 do grupo, em PDF)
